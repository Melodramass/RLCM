#!/bin/bash
# =============================================================================
# Experiment e28 — GRPO + Forced Output + Probe (conf_diff_v2)
# =============================================================================
#
# GOAL
...
#
#   ── Probe reward (conf_diff_v2 mode, margin_corner=True) ──
...
#
#       Corner cases (margin_corner=True):
#         • All budgets correct  (conf_incorrect empty) → alpha * (mu_conf_correct - tau)
#         • All budgets incorrect (conf_correct  empty) → alpha * (tau - mu_conf_incorrect)
#
...
RAY_DEDUP_LOGS=0 PYTHONUNBUFFERED=1 python3 -m verl.trainer.ppo.forced_output.main_forced_output_grpo \
    ...
    +forced_output.probe.reward_mode=brier \
