...
#   • Base model: Qwen/Qwen3-4B-Instruct-2507  (default; override via --model)
#   • Hardware  : 1 node × 4 GPUs, TP=1
...
#
# RUN
#   bash eqwen3-4b-instruct_0.sh [--model PATH]
# =============================================================================
set -x
ray stop
