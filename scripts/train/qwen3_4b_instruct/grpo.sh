#!/bin/bash
# =============================================================================
# Experiment instruct_1-grpo -- Original GRPO for Qwen3-4B-Instruct
# =============================================================================
#
# GOAL
#   Train the Qwen3-4B-Instruct model with the standard single-turn GRPO setup,
#   matching eqwen3-4b-instruct_0.sh where possible while removing the
#   forced-output/probe auxiliary path.
#
# SETUP
...
#   Hardware  : 1 node x 4 GPUs, TP=2
#
# RUN
#   bash eqwen3-4b-instruct_1-grpo.sh [--model PATH]
# =============================================================================
set -x
ray stop
