...
class ActorRolloutRefWorker(Worker, DistProfilerExtension):
    ...
    def _build_model_optimizer(
        ...
        if self._is_lora:
            ...
            if lora_adapter_path is not None:
                ...
                if isinstance(exclude_modules, str) and "," in exclude_modules:
                    exclude_modules = [m.strip() for m in exclude_modules.split(",")]
                lora_config = {
    ...
    def compute_log_prob(self, data: DataProto):
        ...
        return_hidden_states = data.meta_info.pop("return_hidden_states", False) and not is_lora
        with self.ulysses_sharding_manager:
            with adapter_ctx:
            ...
            if return_hidden_states and "hidden_states" in outputs:
                tensors["hidden_states"] = outputs["hidden_states"]
