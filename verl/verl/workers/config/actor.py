...
class PolicyLossConfig(BaseConfig):
    ...
    # C2GSPG BCE calibration regularizer weight (beta in eq. 6 of the C2GSPG paper).
    # Only used when loss_mode='c2gspg'. Set to 0 to disable.
    c2gspg_bce_beta: float = 0.0
